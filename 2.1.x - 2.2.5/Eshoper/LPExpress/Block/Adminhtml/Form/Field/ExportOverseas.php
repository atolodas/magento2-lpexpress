<?php
/**
 * Export CSV button for lpexpress overseas rates
 *
...
class ExportOverseas extends \Magento\Framework\Data\Form\Element\AbstractElement
{
    /**
     * Backend url /admin
     *
    ...
    public function getElementHtml()
    {
        ...
        $url = $this->_backendUrl->getUrl ( "*/*/exportOverseas", $params );
        $data = [
            'label' => __( 'Export CSV' ),
            'onclick' => "setLocation('" .
                $url .
                "lpoverseastables.csv' )",
            'class' => '',
        ];
